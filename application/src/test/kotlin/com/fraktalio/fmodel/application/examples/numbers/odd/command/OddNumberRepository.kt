 ...
 */
class OddNumberRepository : AggregateEventRepository<OddNumberCommand?, OddNumberEvent?> {
 ...
 */
fun oddNumberRepository(): AggregateEventRepository<OddNumberCommand?, OddNumberEvent?> =
    OddNumberRepository()
