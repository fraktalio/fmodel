 ...
 */
private var evenNumberEventStorage: List<Pair<NumberEvent.EvenNumberEvent?, Long?>> = emptyList()
 ...
 */
class EvenNumberLockingRepository : EventLockingRepository<EvenNumberCommand?, NumberEvent.EvenNumberEvent?, Long?> {

    override fun EvenNumberCommand?.fetchEvents(): Flow<Pair<NumberEvent.EvenNumberEvent?, Long?>> =
 ...
 */
fun evenNumberLockingRepository(): EventLockingRepository<EvenNumberCommand?, NumberEvent.EvenNumberEvent?, Long?> =
